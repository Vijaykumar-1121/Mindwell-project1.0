...
const connectDB = async () => {
    try {
        ...
        const conn = await mongoose.connect(process.env.MONGO_URI, {
            ...
            family: 4 // Force IPv4 to prevent Windows SRV resolution bugs
        });
        ...
        console.error('---------------------------------');
        console.log('Server is running but without a database connection.');
        // process.exit(1); // Do not crash the server in dev mode
    }
};
